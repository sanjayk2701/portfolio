...
const EducationOverview = () => {
  return (
    <div className="Education bg-white text-titleColor h-full w-full p-12 pb-[4rem] mb-12">
      <motion.h3
      ...
      <div className="max-w-[70rem] mx-auto h-full p-8">
        ...
        <div className="mt-8 space-y-8 relative">
          {/* Vertical line */}
          <div className="absolute left-[34.2rem] top-0 w-1 h-[86%] bg-gray-300 transform -translate-x-1/2 z-0 hidden lg:block"></div>
          ...
          <div className="grid grid-cols-2 items-start pb-6">
            ...
            <div className="flex items-start space-x-4">
              <div className="w-7 sm:w-10 flex-shrink-0 flex justify-center z-10">
                <div className="w-7 h-7 sm:w-10 sm:h-10 rounded-full border-[4px] border-primaryColor bg-white"></div>
              </div>
              ...
              >
                ...
                <p className="text-xs sm:text-sm text-gray-600">GPA - 8.0</p>
              </motion.div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 items-start pb-6 ">
            ...
            <div className="flex items-start space-x-4">
              ...
              >
                ...
                <p className=" text-sm text-gray-600 mb-1">Percentage - 73%</p>
              </motion.div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 items-start">
            ...
            <div className="flex items-start space-x-4">
              ...
              >
                ...
                <p className="text-sm text-gray-600 mb-1">Percentage - 84%</p>
              </motion.div>
            </div>
          </div>
        </div>
